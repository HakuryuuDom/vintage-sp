	...
	3: { // Berserker
		...
		4: { // Flatten
			"*": {
				...
				abnormals: {
					...
					24101: { speed: 0.30 },
					88406201: { speed: 0.04 },
					88406202: { speed: 0.055 },
					88406203: { speed: 0.7 },
					88406204: { speed: 0.085 },
					88406205: { speed: 0.1 },
					88406206: { speed: 0.115 },
					88406207: { speed: 0.13 },
					88406208: { speed: 0.145 },
					88406209: { speed: 0.16 },
					88406210: { speed: 0.175 },
					88406211: { speed: 0.19 },
					88406212: { speed: 0.205 },
					88406213: { speed: 0.22 },
					88406214: { speed: 0.235 },
					88406215: { speed: 0.25 },
				},
				race: {
					1: { distance: 78 },
		...
		11: { // Leaping Strike 
			0: {
				...
				abnormals: { 
					88426101: { speed: 0.04 },
					88426102: { speed: 0.055 },
					88426103: { speed: 0.7 },
					88426104: { speed: 0.085 },
					88426105: { speed: 0.1 },
					88426106: { speed: 0.115 },
					88426107: { speed: 0.13 },
					88426108: { speed: 0.145 },
					88426109: { speed: 0.16 },
					88426110: { speed: 0.175 },
					88426111: { speed: 0.19 },
					88426112: { speed: 0.205 },
					88426113: { speed: 0.22 },
					88426114: { speed: 0.235 },
					88426115: { speed: 0.25 },
				},
	...
	8: { // Reaper
		...
		3: { // Double Shear
			"*": {
				length: 2040,
				distance: 16.2,
				noInterrupt: ["1-0", "1-2", 3, 4, 12, 13, 14, 15, 18, 19, 20, 21, 23],
				inPlace: {
					movement: [{
						duration: 2140,
						speed: 1,
			...
			30: { abnormals: { 10151010: { chain: 41 } } },
			40: {
				chains: {
					1: 41,
					5: 41,
		...
		4: { // Tsundere Strike
			"*": {
				...
				noInterrupt: [1, 4, 8, 9, 10, 11, 12, 13, 14, 15, 18, 20, 21, 23],
				interruptibleWithAbnormal: { 10151250: [1, 4, 8, 9, 10, 11, 12, 13, 14, 15, 18, 20, 21, 23] },
				distance: [100, 0],
				talents: [900410],
				inPlace: {
					movement: [
			...
			31: { length: [1757.3, 1038.3] },
			40: {
				length: [1166.3, 1757.3, 1038.4],
				distance: [0, 100, 0],
				chains: {
					1: 60,
					3: 60,
		...
		5: { // Grim Strike
			...
			0: {
				length: [2416, 966],
				noInterrupt: ["1-0", "1-2", 4, 12, 13, 14, 15, 18, 20, 23],
				chains: {
					1: 30,
					3: 30,
					5: 30,
		...
		8: { // Whipsaw
			"*": {
				length: 2511.1,
				noInterrupt: [4, 5, 6, 8, 9, 11, 12, 13, 14, 15, 18, 19, 20, 21, 23],
				talents: [900810],
			},
			0: {
				abnormals: { 10151010: { chain: 40 } },
		...
		9: { // Smite
			"*": {
				...
				length: 1732.8,
				distance: 168,
				noInterrupt: [1, 3, 4, 5, 6, 8, 9, 10, 11, 12, 13, 14, 15, 18, 19, 20, 21, 23],
				inPlace: {
					movement: [{
						duration: 1832,
						speed: 1,
		...
		12: { // Shadow Burst
			...
			0: {
				...
				interruptibleWithAbnormal: { 
					10151250: [1, 3, 4, 5, 6, 8, 9, 10, 11, 13, 14, 15, 18, 20, 21, 23],
				},
		...
		16: { // Shadow Reaping
			0: {
				...
				noInterrupt: [16],
				length: 789.23,
				triggerAbnormal: { 10151010: 19500 }, // is this how this fucking works
			}
		},
		18: { // Shrouded Escape
			0: {
				...
				noInterrupt: [18],
				length: 0,
				triggerAbnormal: { 10151171: 8000 }, //not sure yet tbh
			}
		},
		19: { // Dark Harvest
			"*": {
	...
	9: { // Gunner
		...
		1: { // Blast
			"*": {
				...
				length: 1215,
				noInterrupt: [1, 20],
				abnormalChains: { 10152340: 420101 },
				triggerAbnormal: { 10152011: 3100, 93910009: 1000 },
		...
		9: { // Mana Missiles
			...
			0: {
				...
				length: 1225,
				noInterrupt: [9, 20],
				canInstantCharge: { stage: 2, abnormal: 10152352 }, 
				noRetry: false
			},
			10: {
				distance: -50,
		...
		40: { // Rolling Reload / Dashing Reload
			...
			2: {
				...
				triggerAbnormal: { 10152010: 3100, 10152071: [3100, 45], 10152080: [4100, 20], 10152352: [3000, 30], 10152354: 4000, 10153093: 0x7fffffff, },
			},
			31: true,
			32: {
				consumeAbnormal: [10152352],
				triggerAbnormal: { 10152352: [3000, 50] },
				distance: 200.3,
			},
		},
		41: { // Modular Weapon System
			"*": {
				...
				length: 1600,
				noInterrupt: [41],
				abnormalChains: { 10152010: 2, 10152011: 2 },
				chains: {
					"2-1": 30,
					3: 30,
					4: 30,
		...
		42: { // Detonate
			1: {
				length: 660,
				fixedSpeed: 1,
				noInterrupt: [20, 40, 42],
				triggerAbnormal: { 10152011: 3100, 93910009: 600 },
				consumeAbnormalEnd: 93910009
			}
		},
		43: { // Remote Trigger
			...
			0: {
				length: 592,
				triggerAbnormal: { 10152331: [1800, 25] },
			},
			1: {
				distance: -108.2,
				abnormalChains: { 10152340: 3, 10152331: 31 },
				triggerAbnormal: { 10152331: [1800, 25] },
			},
			3: {
				distance: -108.2,
