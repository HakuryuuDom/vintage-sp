...
class State extends EventEmitter {
	constructor() {
		...
		Object.assign(this, {
			...
			presetFilePath: utils.getFullPath("../config/preset.js"),
			...
			skillsFilePath: utils.getFullPath("../config/data/skills.js"),
			talentsFilePath: utils.getFullPath("../config/data/talents.json"),
	...
	LoadSkillsByPatch(mod) {
		...
		{
			this.preset = require(this.presetFilePath);
			this.skills = require(this.skillsFilePath);
			if(!this.preset[4][4] || !this.preset[4][33]){
				this.preset[4][4] = false;
				this.preset[4][33] = false;
			}
